...
public class CarService {
    ...
    public CarService(CarRepository repository, @Qualifier("pricing") WebClient pricingWebClient,@Qualifier("maps") WebClient webClientMaps, ModelMapper modelMapper) {
        /**
    ...
    public Car findById(Long id) {
        ...
        PriceClient priceClient = new PriceClient(pricingWebClient);
